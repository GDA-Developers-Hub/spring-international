    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <h1 className="text-4xl md:text-6xl font-bold mb-6">German Language Courses</h1>
              <p className="text-xl max-w-3xl mb-8">
                Learn German, the language of innovation and European business, with our comprehensive and interactive
                courses.
              </p>
            ...
            >
              <div className="relative h-[400px] w-full">
                <Image
                  src="https://images.unsplash.com/photo-1527866512907-a35a62a0f6c5?q=80&w=800&auto=format&fit=crop"
      ...
      <section className="py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0046ad]">About Our German Courses</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our German language programs are designed to help you develop practical communication skills for academic,
              professional, and personal success in a German-speaking environment.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold mb-4 text-[#0046ad]">Why Learn German?</h3>
              <div className="space-y-4">
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h4 className="font-bold text-gray-800">Economic Powerhouse</h4>
                    <p className="text-gray-600">
                      Germany has the largest economy in Europe and is a global leader in engineering, automotive, and
                      technology sectors.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      German language skills open doors to careers in international business, engineering, science, and
                      tourism.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Germany offers world-class education with many universities offering free or low-cost tuition,
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Access a rich cultural tradition of literature, philosophy, music, and art from figures like
                      Goethe, Kant, Bach, and Beethoven.
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Experience German culture through music, film, literature, and culinary activities integrated into
                    the curriculum.
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h4 className="font-bold text-gray-800 mb-2">Goethe-Institut Preparation</h4>
                  <p className="text-gray-600">
                    Our courses align with the Common European Framework of Reference (CEFR) and prepare you for
                    official German proficiency exams.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            {[
              {
                level: "Beginner (A1)",
                description:
                  "For students with no prior knowledge of German. Learn basic vocabulary, simple grammar, and everyday expressions.",
                duration: "12 weeks",
                topics: [
      ...
      <section className="py-16 px-4 md:px-8 bg-[#0046ad] text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Enroll in our German language courses today and open doors to new cultures, opportunities, and experiences.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
