    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <h1 className="text-4xl md:text-6xl font-bold mb-6">Spanish Language Courses</h1>
              <p className="text-xl max-w-3xl mb-8">
                Speak Spanish like a native! Our Spanish courses are tailored to beginners and advanced learners who
                want to stand out globally.
              </p>
      ...
      <section className="py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0046ad]">About Our Spanish Courses</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Spanish language programs are designed to help you develop practical communication skills for
              academic, professional, and personal success in a Spanish-speaking environment.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold mb-4 text-[#0046ad]">Why Learn Spanish?</h3>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Spanish is spoken by over 460 million people worldwide and is an official language in 21 countries
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Spanish opens doors to careers in international business, tourism, diplomacy, translation, and
                      many other fields.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Access Spanish literature, cinema, art, and music in their original form, enriching your cultural
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Enhance your travel experiences in Spain, Mexico, Argentina, Colombia, and numerous other
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Experience Spanish culture through music, film, literature, and culinary activities integrated into
                    the curriculum.
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h4 className="font-bold text-gray-800 mb-2">DELE Preparation</h4>
                  <p className="text-gray-600">
                    Our courses align with the Common European Framework of Reference (CEFR) and prepare you for
                    official Spanish proficiency exams.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            {[
              {
                level: "Beginner (A1)",
                description:
                  "For students with no prior knowledge of Spanish. Learn basic vocabulary, simple grammar, and everyday expressions.",
                duration: "12 weeks",
                topics: [
      ...
      <section className="py-16 px-4 md:px-8 bg-[#0046ad] text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Ready to Start Your Spanish Language Journey?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Enroll in our Spanish language courses today and open doors to new cultures, opportunities, and experiences.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
