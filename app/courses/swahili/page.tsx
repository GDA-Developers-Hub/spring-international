...
export default function SwahiliCoursePage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <h1 className="text-4xl md:text-6xl font-bold mb-6">Swahili Language Courses</h1>
              <p className="text-xl max-w-3xl mb-8">
                Connect with East Africa through Swahili, a lingua franca that offers expansive communication across
                African countries.
              </p>
            ...
            >
              <div className="relative h-[400px] w-full">
                <Image
                  src="https://images.unsplash.com/photo-1489493887464-892be6d1daae?q=80&w=800&auto=format&fit=crop"
                  alt="Swahili Language Course"
                  fill
      ...
      <section className="py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0046ad]">About Our Swahili Courses</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Swahili language programs are designed to help you develop practical communication skills for
              academic, professional, and personal success in East Africa and beyond.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold mb-4 text-[#0046ad]">Why Learn Swahili?</h3>
              <div className="space-y-4">
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h4 className="font-bold text-gray-800">Regional Lingua Franca</h4>
                    <p className="text-gray-600">
                      Swahili is spoken by over 100 million people across East and Central Africa, serving as a common
                      language in Kenya, Tanzania, Uganda, and beyond.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Swahili skills open doors to careers in international development, tourism, diplomacy, and
                ...
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h4 className="font-bold text-gray-800">Cultural Gateway</h4>
                    <p className="text-gray-600">
                      Access rich cultural traditions, literature, music, and art from the Swahili coast and throughout
                      East Africa.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h4 className="font-bold text-gray-800">Growing Importance</h4>
                    <p className="text-gray-600">
                      As East African economies grow, Swahili is becoming increasingly important for international
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Experience East African culture through music, film, literature, and culinary activities integrated
                    into the curriculum.
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h4 className="font-bold text-gray-800 mb-2">Regional Variations</h4>
                  <p className="text-gray-600">
                    Learn about the different dialects and variations of Swahili across East Africa, with a focus on
                    standard Swahili.
                  </p>
                </div>
              </div>
            ...
            {[
              {
                ...
                description:
                  "For students with no prior knowledge of Swahili. Learn basic vocabulary, simple grammar, and everyday expressions.",
                duration: "12 weeks",
                topics: [
      ...
      <section className="py-16 px-4 md:px-8 bg-[#0046ad] text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Ready to Start Your Swahili Language Journey?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Enroll in our Swahili language courses today and open doors to new cultures, opportunities, and experiences
            in East Africa.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
